...
const FeedbackScreen = () => {
  ...
  return (
    <PageLayout title="Feedback / Suggestions">
      <div className="flex flex-1 flex-col p-4 max-w-md mx-auto w-full relative bg-gray-100">
        <div className="space-y-6 flex flex-col flex-1">
          ...
          {/* Feedback Form */}
          <form onSubmit={handleSubmit} className="flex-1 space-y-4 flex flex-col">
            ...
            <Button
              type="submit"
              className="w-full h-12 bg-[#43A047] hover:bg-[#388E3C] text-white text-base font-medium rounded-xl"
