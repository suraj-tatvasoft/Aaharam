    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#2121211A] p-2 backdrop-blur-[4px]">
      <div className="flex w-[305px] flex-col items-center justify-center gap-0 rounded-[16px] bg-[#F5F5F5] p-0 shadow-[0px_-6px_20px_0px_#A8A8A866]">
        <div className="flex w-full flex-col items-center rounded-t-[16px] bg-white px-4 py-5">
          <span className="text-center text-[16px] font-medium leading-[11px] text-[#212121]">Log out</span>
        </div>
        ...
        <div className="flex w-full flex-row items-center justify-center gap-4 rounded-b-[16px] bg-white">
          <button
            onClick={onClose}
            className="h-[50px] flex-1 bg-transparent p-0 text-[14px] font-medium leading-[10px] text-[#212121B3] shadow-none"
          >
            No
          </button>
          <button onClick={onLogout} className="h-[50px] flex-1 bg-transparent p-0 text-[14px] font-medium leading-[10px] text-[#38963B] shadow-none">
            Yes
          </button>
        </div>
      </div>
